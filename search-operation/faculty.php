              ...
              if(isset($_POST['add1'])){
                ...
                echo "<form action=\"faculty.php\" method=\"post\">
                  <table width=\"100%\" border=\"0\" style=\"border:none;\">
                    <tr>
                      <td><label>Sap Id:&nbsp;</label><input type=\"text\" name=\"sapid\" /></td>
                    </tr>
                    <tr>
                      <td><label>Name:&nbsp;</label><input type=\"text\" name=\"name\" /></td>
                    </tr>
                    <tr>
                      <td><label>Department:&nbsp;</label><input type=\"text\" name=\"department\" /></td>
                    </tr>
                  </table>
                  ...
                  $conditions = array();
                  if(! empty($a)){
                    $conditions[] = "sapid LIKE '%$a%'";
                  }
                  if(! empty($b)){
                    $conditions[] = "name LIKE '%$b%'";
                  }
                  if(! empty($c)){
                    $conditions[] = "dept LIKE '%$c%'";
                  }
                              ...
                              <table>
                                <thead>
                                  <tr class=\"row100 head\">
                                    ...
                                    <th class=\"cell100 column2\">Salary</th>
                                  </tr>
                                </thead>
                              </table>
                            </div>";
                  ...
                  if ($result->num_rows > 0) {
                      ...
                      while($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class=\"cell100 column2\">" .$row["salary"]. "</td>";
                        echo "</tr>";
                      }
                      echo "</tbody>
                            </table>
