...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 19, 2018 at 05:43 PM
...
(1, 'purvil', 'unknown', '2018-08-21', 25, 'mumbai', 'comps', 66),
(2, 'aayush', 'male', '2018-07-23', 432, 'kandivali', 'comps', 20),
(3, 'pjjw', 'male', '2018-09-29', 4231, 'malad', 'IT', 25),
(12, 'test', 'Female', '2014-10-19', 14124, 'q2rcq2r23', 'comps', 34),
(65, 'test testL', 'Female', '2016-11-19', 14124, 'qedr4', 'comps', 34),
(111, 'test', 'Male', '2018-10-19', 14124, '2313ewff', 'comps', 34),
(123, 'test', 'Male', '2009-10-19', 14124, 'ibgvuugyb', 'comps', 34);
...
--
ALTER TABLE `alumni`
  ADD CONSTRAINT `alumni_ibfk_1` FOREIGN KEY (`sapid`) REFERENCES `student` (`sapid`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `student`
  ADD CONSTRAINT `student_ibfk_1` FOREIGN KEY (`sapid`) REFERENCES `person` (`sapid`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
