...
<?php
    ...
    if(isset($_POST['add'])){
        $a =  $_POST['student'];
        $sql = "DELETE FROM `student` WHERE sapid='$a'";
            ...
            <div class=" col-md-6">
                <div class="card">
                    ...
                    <div class="card-body card-block">
                            ...
                            <div class="row form-group">
                                <div class="col col-md-3">
                                    <label for="text-input" class=" form-control-label">Student</label>
                                </div>
                                <div class="col-12 col-md-9">
                                  <?php
                                  $conn = OpenCon();
                                  ...
                                  $result = mysqli_query($conn, $sql);
                                    echo '<select id="text-input" name="student" class="form-control">';
                                    echo '<option disabled selected value>Select Student to delete</option>';
